  ...
  return (
    <section id="volunteer" className="py-10 px-4 max-w-4xl mx-auto">
      ...
      <p className="text-[#0e1b18] text-base pb-3 text-center">
        ...
        We offer various opportunities to get involved, from on-site support to remote assistance.
      </p>
      <div className="flex justify-center py-3">
        <button className="h-10 px-4 bg-[#15cfa4] text-[#0e1b18] rounded-full font-bold">Become a Volunteer</button>
      </div>
    </section>
  );
}
